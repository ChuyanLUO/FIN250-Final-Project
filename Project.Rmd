...
#mean annualized standard deviation
mean(pretConstant.month$sd)*sqrt(12)
...
#mean annualized standard deviation
mean(pretEquity.month$sd)*sqrt(12)
...
A.volatility[1]<-mean(pret.month$sd)*sqrt(12)
A.volatility[2]<-mean(pretConstant.month$sd)*sqrt(12)
A.volatility[3]<-mean(pretEquity.month$sd)*sqrt(12)
A.sharp_ratio[1]<-(mean(pret.month$ret)*12-0.03)/(mean(pret.month$sd)*sqrt(12))
A.sharp_ratio[2]<-(mean(pretConstant.month$ret)*12-0.03)/(mean(pretConstant.month$sd)*sqrt(12))
A.sharp_ratio[3]<-(mean(pretEquity.month$ret)*12-0.03)/(mean(pretEquity.month$sd)*sqrt(12))
